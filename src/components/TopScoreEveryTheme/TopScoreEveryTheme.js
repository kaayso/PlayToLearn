...
const TopScoreEveryTheme = (props) => (
  <View style={styles.trophyItem}>
    <Image source={AvatarsManager.getAvatar(props.item.user[0].detailUser.picture)} style={styles.img} />
    <View style={styles.nbTrophyContainer}>
      <Text style={styles.numberOfTrophy}>{props.item.user[0].score}</Text>
    </View>
    <View style={styles.bottomContainer}>
      ...
      <Text style={styles.themeName}>{upperFirst(props.item.user[0].detailUser.username)}</Text>
    </View>
  </View>
);
export default TopScoreEveryTheme;
